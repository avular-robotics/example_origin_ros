...
To start the Zenoh bridge on you local machine you should run "ROS_DOMAIN=123; zenoh-bridge-ros2dds -e tcp/<robot-ip>:7447". Note that we define a new ROS2 domain. This is not compulsory but may prevent ROS2 communication issues later on.
5. Check the connection
Open a new terminal and run "ROS_DOMAIN=123; ros2 topic list", or "ROS_DOMAIN=123; rviz2". 
